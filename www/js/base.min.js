...
XIAOMI.app.footer = {
    ...
    conference0515: function () {
        function showCountLogo(ttime) {
            var $text, remainTime = targetTime.getTime() - 1e3 * ttime,
...
XIAOMI.app.navCategory = function () {
    ...
    function init() {
        ...
        if (XIAOMI.app.analytics([$(".nav-category-content > a"), $(".nav-category-content .links").find("a"), $(".nav-category-content .children-list").find("a"), $(".nav-category-content .children-special-section").find("a")], {
            page: "分类导航",
            position: ["A", "B", "C", "D"],
            mstPage: "HP",
            mstArea: "PC",

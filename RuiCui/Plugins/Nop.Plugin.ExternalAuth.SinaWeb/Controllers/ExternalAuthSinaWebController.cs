...
namespace Nop.Plugin.ExternalAuth.SinaWeb.Controllers
{
    public class ExternalAuthSinaWebController : BasePluginController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nop.Plugin.ExternalAuth.SinaWeb.Views.ExternalAuthSinaWeb.Configure", model);
        }
        ...
        {
            return View("Nop.Plugin.ExternalAuth.SinaWeb.Views.ExternalAuthSinaWeb.PublicInfo");
        }

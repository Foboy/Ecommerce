...
namespace Nop.Plugin.Widgets.NivoSlider
{
    ...
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        {
            return new List<string>() { "home_page_top", "home_page_right_top", "home_page_root", "home_page_right2", "home_page_hot", "home_page_new", "home_page_star", "home_page_like" };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            switch (widgetZone)
            {
                case "home_page_top":
                       ...
                       controllerName = "Index";
                    break;
                case "home_page_right_top":
                    actionName = "PublicInfoIndexRightTop";
                    controllerName = "Index";
                    break;
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Picture1", "图片1");
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Picture", "图片");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Picture.Hint", "上传图片");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Text", "标题");

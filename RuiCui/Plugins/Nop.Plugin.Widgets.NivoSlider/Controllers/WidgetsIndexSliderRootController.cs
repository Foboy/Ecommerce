...
{
    public class WidgetsIndexSliderRootController : BasePluginController
    {
        ...
        public WidgetsIndexSliderRootController(IWorkContext workContext,
        ...
        [AdminAuthorize]
        [ChildActionOnly]
        public ActionResult Configure(ConfigurationIndexSliderRootModel model)
        {
            //load settings for a chosen store scope
            var storeScope = this.GetActiveStoreScopeConfiguration(_storeService, _workContext);
            var nivoSliderSettings = _settingService.LoadSetting<NivoIndexSliderRootSettings>(storeScope);
